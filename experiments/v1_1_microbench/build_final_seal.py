#!/usr/bin/env python3
"""Create the final targeted-microbenchmark manifest and checksum ledger."""
...
MANIFEST = ROOT / "11_FINAL_FILE_MANIFEST.csv"
CHECKSUMS = ROOT / "12_FINAL_CHECKSUMS_SHA256.txt"
